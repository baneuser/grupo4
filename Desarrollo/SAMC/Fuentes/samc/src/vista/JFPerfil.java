...
public class JFPerfil extends javax.swing.JFrame implements IPerfil {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jbtCambiarPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 70, -1, 20));

        jckbActivo.setBackground(new java.awt.Color(255, 255, 255));
        jckbActivo.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jckbActivo.setForeground(new java.awt.Color(255, 255, 255));
        jckbActivo.setText("Activo");
        jckbActivo.setBorder(null);
        jckbActivo.setOpaque(false);
        getContentPane().add(jckbActivo, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 100, 70, 40));
        ...
        getContentPane().add(jbtGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 300, 70, 30));
        ...
        getContentPane().add(jbtCerrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 300, 70, 30));
